                  ...
                  children: [
                    Flexible(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(lignePanier.name, style: normal_text(),),
                                      SizedBox(height: 10),
                          Image.network(
                              ...
                              SizedBox(height: 10),
                          Text(prixTotal.toStringAsFixed(2)+" DHs", style: prix_transaction(),),
                        ],
                      ),
                    ),
                    Flexible(
                          ...
                          children: [
                            Container(
                              ...
                              child: DropdownButtonFormField(
                                ...
                                onChanged: (value) {
                                  PanierService.updateQuantite(lignePanier.id, value).then((value){
                                    print("------*********---------********");
                                    print(value);
                                    print("------*********---------********");
                                    setState(() {
